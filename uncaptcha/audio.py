...
def wit(audio, vals, i, results_dict, timing):
	...
	WIT_AI_KEY = "XCG4CDF6EY4BYXI7S7JRGPFEU6745U7U"  # Wit.ai keys are 32-character uppercase alphanumeric strings
	try:
		s = time.time()
		#print("Wit.ai: ")
...
def getNum(audio_file, results_dict, digit_num=0, ans=[]):
	...
	for api in apis_func:
		t = multiprocessing.Process(target=api, args=(r, audio, ret_vals, i, results_dict_threaded, timed))
		threads.append(t)
		t.start()
		i += 1
